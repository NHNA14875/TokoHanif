...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="index.html" class="logo d-flex align-items-center">
      ...
      <span class="d-none d-lg-block">TokoH</span>
    </a>
    ...
    <ul class="d-flex align-items-center">
      ...
      </li><?php if (session()->has('diskon')) : ?>
        <li class="nav-item">
            <a class="nav-link nav-icon" href="#" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Diskon Hari Ini!">
                <i class="bi bi-tag-fill"></i>
                <span class="badge bg-danger badge-number"><?= number_to_currency(session('diskon'), 'IDR', 'id_ID', 0) ?></span>
            </a>
        </li>
      <?php endif; ?>
